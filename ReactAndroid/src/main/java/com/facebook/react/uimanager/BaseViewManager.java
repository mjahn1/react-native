...
public abstract class BaseViewManager<T extends View, C extends LayoutShadowNode>
  ...
  public void setTestId(T view, String testId) {
    if (!TEST_IDS.containsKey(testId)) {
      int id = view.getResources().getIdentifier(testId, "id", view.getContext().getPackageName());
      System.out.println("=============================");
      System.out.println("=============================");
      System.out.println("=============================");
      System.out.println("=============================");
      System.out.println("ID is " + id);
      TEST_IDS.put(testId, id);
    }
    ...
    System.out.println("=============================");
    System.out.println("=============================");
    System.out.println("mapped TEst ID is " + mappedTestId);
